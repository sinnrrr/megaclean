...
return [
    ...
    => 'Предоставление, установка и монтаж, а также посещение туалетов после истечения срока действия договора - бесплатно!',
    ...
    => 'Арендуемые клиентами туалеты регулярно моются и содержатся в комфорте с использованием специального оборудования и немецкого туалетного концентрата WC CLEANER.',


    'The service includes:'
    => 'Услуга включает в себя:',
    'removal of dirt from the toilet'
    => 'удаление грязи из туалета',
    ...
    => 'первым делом необходимо опорожнить унитаз, что делается откачиванием грязи через отверстие под крышкой унитаза с помощью специального насоса, приспособленного для работы эко-туалетов, установленного на цистерне',
    ...
    => 'чистый резервуар залит смесью концентрата WC CLEANER и воды, которая должна нейтрализовать загрязнения и эффективно устранить неприятные запахи',
    'toilet paper and fragrances are replenished after maintenance'
    => 'туалетная бумага и ароматизаторы пополняются по окончании обслуживания',
