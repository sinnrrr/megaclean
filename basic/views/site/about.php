...
<!--    <img src="/basic/web/img/about/experience.png" alt="" style="float: right; height: 200px;">-->
    <p><?= \Yii::t('app', "With more than 9 years of experience in the field of portable sanitation, Megaclin has built an impeccable reputation in the field of rental and maintenance of mobile sanitary systems, which meets and exceeds the needs of our customers.") ?></p>

    <p><?= \Yii::t('app', "The use of portable toilets (dry toilets), washbasins and other sanitary equipment of well-known world brands for rent is a major step forward, made thanks to all the useful advice of many customers. During operation, our equipment can withstand constant loads and even abuse, but it is easy to clean and maintain, which creates a comfortable environment for both users and operators.") ?></p>
