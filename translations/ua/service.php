...
return [
    ...
    => 'Послуга сервісу здійснюється відповідно до вказівок і очікувань наших клієнтів - вона може бути включена в ціну, розраховану за оренду мобільної туалетної кабіни.',
    ...
    => 'Орендовані клієнтами біотуалети регулярно миються і перебувають в комфортному стані це все відбувається з використанням спеціального обладнання та німецького туалетного концентрату Disinfectant cleaner.',


    'The service includes:'
    => 'Послуга сервісного обслуговування біотуалету включає в себе:',
    'removal of dirt from the toilet'
    => 'утилізація нечистот',
    'cleaning and disinfection of the toilet'
    => 'миття,чистка та дезінфекція біотуалету',
    'filling the tank with German concentrate WC CLEANER'
    => 'заправка резервуара німецьким концентратом',
    'addition of toilet paper'
    => 'забезпечення туалетним папером',
    'adding flavors'
    => 'ароматизація туалетної кабіни',
    ...
    => 'насамперед необхідно спорожнити накопичувальний бак біотуалету, цей процес відкачуванням здійснюється через отвір баку за допомогою спеціального вакуумного обладнання, пристосованого для роботи з біотуалетами, встановленого на автоцистерні',
    ...
    => 'в чистий резервуар заливають суміш концентрату WC BLUE і води, яка повинна нейтралізувати нечистоти і ефективно усунути неприємні запахи',
    'toilet paper and fragrances are replenished after maintenance'
    => 'туалетний папір і ароматизатори поповнюються після закінчення попередніх процесів обслуговування',


    'Toilet service is always performed taking into account the individual needs and requirements of the client.'
    => 'Послуга сервісу біотуалету завжди виконується з урахуванням індивідуальних потреб і вимог замовника.',
];
